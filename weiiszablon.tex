...
W niniejszym rodziale szczegółowo omówiono przykłady gier z gatunku roguelike. Omówione gry to 1: Rogue, 2: Caves of Qud, 3: The Binding of Isaac.


\subsection{Rogue}


Rogue: Exploring the Dungeons of Doom to zaprogramowana w 1980 roku przez Michael-a Toy i Glenn-a Wichman gra, która zapoczątkowała gatunek Roguelike. Gracz wciela się w postać podróżującą w głąb podziemi w celu odnaleznia amuleto Yendoru. W trakcie rozgrywki napotkać można wielu przeciwników, a w walce z nimi pomagają znajdowane na poziomach przedmioty i ekwpiunek. Rogue oparta jest o system turowy, przeciwnicy mogą wykonać ruch dopiero po ruchu gracza. W wyniku tego gra pozwala na dowolnie długie przemyślenie każdego ruchu i taktyczne podejście do walki.


Na rysunku \ref{Rogue:scr1} przedstawiono fragment rozgrywki w grze Rogue. Żółtymi liniami oznaczone są ściany pokojów, zielonymi kropkami podłogi, na szaro oznaczono korytarze. Żólty pytajnik reprezentuje postać gracza przeciwnicy są oznaczani literami jak lodowy potwór oznaczony literą 'I' na rysunku.
...
\begin{figure}[h]
	...
	\caption{Zrzut ekranu z gry Rogue}
	\label{Rogue:scr1}
\end{figure}
